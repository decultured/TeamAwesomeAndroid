...
public class NovaBackground
{
	...
	public void Render()
	{
		...
		images[_AdjustOffset(baseIndex+1)].RenderZ(0.0f,(float)Math.floor(offset+screenW) - 5);
		images[_AdjustOffset(baseIndex+2)].RenderZ(0.0f,(float)Math.floor(offset+screenW*2) - 10);
	}
}
